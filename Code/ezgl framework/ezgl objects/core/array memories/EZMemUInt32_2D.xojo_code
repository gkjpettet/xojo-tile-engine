#tag Class
Protected Class EZMemUInt32_2D
Inherits MemoryBlock
	...
	#tag Method, Flags = &h1000
		Sub Constructor(lastIndex As integer)
		  ...
		  Super.Constructor((lastIndex + 1) * 8)
	...
	#tag Method, Flags = &h0
		Sub set(idx As integer, x As UInt32, y As UInt32)
		  //no bounds checking of idx
		  
		  dim base As integer = idx * 8
		  
		  refPtr.UInt32(base) = x
		  refPtr.UInt32(base+4) = y
